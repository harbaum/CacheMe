...
void KQOAuthAuthReplyServerPrivate::onBytesReady() {
    ...
    QByteArray reply;
    QByteArray content;
    content.append("<html><head><title>Authorized</title></head><body>"
		   "<font face=\"Verdana\"><table>" 
		   "<tr align=\"center\" bgcolor=\"#60713c\"><td><font color=\"white\" size=\"5\">"
		   "Authorization completed</font></td></tr>"
		   "<tr align=\"center\"><td>"
		   "<p><b>CacheMe</b> is now authorized to access geocaching.com on your behalf.</p>"
