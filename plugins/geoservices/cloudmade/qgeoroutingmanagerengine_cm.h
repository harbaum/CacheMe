...
#ifndef QGEOROUTINGMANAGER_CLOUDMADE_H
#define QGEOROUTINGMANAGER_CLOUDMADE_H
...
class QGeoRoutingManagerEngineCm : public QGeoRoutingManagerEngine
{
    Q_OBJECT
public:
    QGeoRoutingManagerEngineCm(const QMap<QString, QVariant> &parameters,
                                  QGeoServiceProvider::Error *error,
                                  QString *errorString);
    ~QGeoRoutingManagerEngineCm();
